...
## Try our open source solutions
![Screenshot of open source solutions by SloopStash at GitHub.](https://github.com/sloopstash/.github/blob/master/asset/image/open-source/banner.png)
...
### VM images
- [Vagrant registry](https://portal.cloud.hashicorp.com/vagrant/discover/sloopstash)

### Container (OCI) images
- [Docker Hub](https://hub.docker.com/u/sloopstash)

### Cloud, DevOps, Platform, and OS starter-kits
...
- [Helm](https://github.com/sloopstash/kickstart-helm)
...
### Fullstack apps
- [Python + Redis + Nginx (CRM stack)](https://github.com/sloopstash/sloopstash-crm-app)
- [NodeJS + MongoDB + Nginx (CTM stack)](https://github.com/sloopstash/sloopstash-ctm-app)
- [Ruby + PostgreSQL + Nginx (NTM stack)](https://github.com/sloopstash/sloopstash-ntm-app)


## Get support
Interested in our open source solutions? Just send us a message, we're here to support you.
